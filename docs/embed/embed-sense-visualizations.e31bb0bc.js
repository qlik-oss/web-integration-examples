...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"config.js":[function(require,module,exports) {
var url = new URL(location.href); // this should correspond to the QCS tenant URL, or QSE on Kubernetes deployment:

var tenantUrl = url.searchParams.get('tenant') || 'https://elastic.example'; // this should correspond to an web integration id that:
...
var webIntegrationId = url.searchParams.get('wiid') || 'web-integration-id-here'; // should be Helpdesk Management resourceId:

var appId = url.searchParams.get('app') || 'app-id-here';
var tenant = new URL(tenantUrl);
module.exports = {
...
},{}],"comm.js":[function(require,module,exports) {
var _require = require('./config'),
    isSecure = _require.isSecure,
    host = _require.host,
    port = _require.port,
    webIntegrationId = _require.webIntegrationId;

var baseUrl = (isSecure ? 'https://' : 'http://') + host + (port ? ':' + port : '');

var _deserialize = function _deserialize(response) {
...
var _require = require('./comm'),
    getUser = _require.getUser,
    getTenant = _require.getTenant,
    getAppList = _require.getAppList,
    baseUrl = _require.baseUrl;

var link = document.createElement('link');
link.rel = 'stylesheet';
link.href = "".concat(baseUrl, "/resources/autogenerated/qlik-styles.css");
document.head.appendChild(link);
var script = document.createElement('script');
script.src = "".concat(baseUrl, "/resources/assets/external/requirejs/require.js");
script.onload = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
  var loginUrl, loginBtn, logoutBtn, _yield$Promise$all, _yield$Promise$all2, user, tenant;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          loginUrl = new URL("".concat(baseUrl, "/login"));
          ...
          logoutBtn.addEventListener('click', function () {
            location.href = new URL("".concat(baseUrl, "/logout"));
          });
          _context.next = 10;
          return Promise.all([getUser(), getTenant()]);

        case 10:
          _yield$Promise$all = _context.sent;
          _yield$Promise$all2 = _slicedToArray(_yield$Promise$all, 2);
          user = _yield$Promise$all2[0];
          tenant = _yield$Promise$all2[1];
...
function renderError(error) {
  document.querySelector('#QV01').innerHTML = "Failed to render charts: <pre><code>".concat(error.error || error.stack || error.message || error, "</code></pre>");
}

function initMashup() {
  return _initMashup.apply(this, arguments);
}

function _initMashup() {
  _initMashup = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var list, ulElement, appIds;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            list.data.forEach(function (appItem) {
              var liElement = document.createElement('li');
              liElement.innerHTML = "<b>".concat(appItem.name, "</b> - ").concat(appItem.resourceId);
              ulElement.appendChild(liElement);
            });
            document.querySelector('#app_list').appendChild(ulElement);
            appIds = list.data.filter(function (appItem) {
              return appItem.name.indexOf('drug') !== -1;
            }).map(function (appItem) {
              return appItem.resourceId;
            });
            requirejs(['js/qlik'], /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(qlik) {
                var app, vis, vis2;
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        app = qlik.openApp(appIds.length ? appIds[0] : config.appId, config);
                        app.on('error', renderError);
                        app.getObject('CurrentSelections', 'CurrentSelections');
                        _context2.prev = 3;
                        _context2.next = 6;
                        return app.visualization.create('piechart', [{
                      ...
                      case 6:
                        ...
                        vis.show('QV01');
                        _context2.next = 10;
                        return app.visualization.get('ced9d474-cad3-4df5-bc09-06d27dcf634a');
...
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","./config":"config.js","./comm":"comm.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/embed-sense-visualizations.e31bb0bc.js.map